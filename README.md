...
### [`original`](https://github.com/MaxSvargal/snapping-scroll/tree/original) — Initial implementation

Hand-written JS virtual scrolling, 196 LOC. Shared observer pool and RAF debouncing.

### [`minimal-perfomanced`](https://github.com/MaxSvargal/snapping-scroll/tree/minimal-perfomanced) — Performance optimizations
...
### [`main`](https://github.com/MaxSvargal/snapping-scroll/tree/main) — Production-ready
